...
public class JFXScrollPane extends StackPane {
    ...
    public JFXScrollPane() {
        ...
        condensedHeaderBackground.setBackground(new Background(new BackgroundFill(Color.TRANSPARENT,
                CornerRadii.EMPTY,
                Insets.EMPTY)));
        headerBackground.setBackground(new Background(new BackgroundFill(Color.TRANSPARENT,
                CornerRadii.EMPTY,
                Insets.EMPTY)));
        ...
        header.setPrefHeight(32 * 3);
//        https://stackoverflow.com/questions/24607969/mouse-events-get-ignored-on-the-underlying-layer
//        Mouse Events get Ignored on the Underlying Layer;  Solved
//        If setMouseTransparent(true) directly would cause bug
//        So the best way is make its width binds with contents's width
//        Cancel header's private prefix, therefor you can force its width
//        as equal as 0.9 times of contents's.
...
//        header is above the scrollPane
